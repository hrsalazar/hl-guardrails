...
`pytest -q` runs 267 tests in about 2 seconds. An autouse fixture blocks all network access, so
...
Separately, `tests/e2e` drives `pwa/index.html` in real Chromium via Playwright (78 tests, ~50s):
