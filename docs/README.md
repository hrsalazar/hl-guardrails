...
| Document | For | Covers |
|---|---|---|
| [operations.md](operations.md) | whoever runs it | setup from scratch, devices and push, health checks, troubleshooting |
...
backtest, timeframe and macro-filter results with their numbers.
